...
class VGG19(object):
    ...
    def build_model(self):
        ...
        # block 1: 3 -> 64 -> 64, 224x224 -> 112x112
        ...
        # block 2: 64 -> 128 -> 128, 112x112 -> 56x56
        ...
        # block 3: 128 -> 256 -> 256 -> 256 -> 256, 56x56 -> 28x28
        ...
        # block 4: 256 -> 512 -> 512 -> 512 -> 512, 28x28 -> 14x14
        ...
        # block 5: 512 -> 512 -> 512 -> 512 -> 512, 14x14 -> 7x7
        ...
        # 224x224 经过 5 次 2x2 池化后：7x7，通道 512
    ...
    def load_model(self):
        ...
        for idx in range(43):
            if 'conv' in self.param_layer_name[idx]:
                ...
                # 从 [H, W, in_C, out_C] 变成 [in_C, H, W, out_C]

                bias = bias.reshape(-1)
                # matconvnet 的 bias 可能是 [1, 1, out_C, 1] 或 [1, out_C]，拉平成 [out_C]
